...
package com.example.quickboard.tflite;
...
import com.example.quickboard.MainActivity;
...
//        d.ANCHORS = anchors;
        ...
        d.numClass = numClass;
        d.outData = ByteBuffer.allocateDirect(d.output_box * (numClass + 5) * numBytesPerChannel*1);
